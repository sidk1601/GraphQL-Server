...
class Feed extends Component {
    ...
    .then(fileResData => {
      ...
      if(this.state.editPost) {
        graphqlQuery = {
          query: `
          mutation {
            editPost(postId: "${this.state.editPost._id}", postData: {
              title: "${postData.title}",
              content: "${postData.content}",
              imageUrl: "${imageUrl}"
            }) {
      ...
      // let url = `${localServer}/feed/post`;
      // let method = 'POST';
      // if (this.state.editPost) {
      //   url = `${localServer}/feed/post/${this.state.editPost._id}`;
      //   method = 'PUT';
      // }
  ...
  deletePostHandler = postId => {
    ...
    fetch(`${localServer}/feed/post/${postId}`, {
      method: 'DELETE',
      headers: {
        Authorization: 'Bearer ' + this.props.token
      }
